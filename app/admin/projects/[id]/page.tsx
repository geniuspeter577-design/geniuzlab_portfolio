            ...
            {deleteConfirm ? (
              <>
                ...
                <button
                  ...
                  disabled={deleting}
                  className="rounded-full border border-red-600 bg-red-600/10 px-4 py-2 text-xs uppercase tracking-[0.18em] text-red-500 transition hover:bg-red-600/20 disabled:opacity-70"
                >
              ...
              <button
                ...
                className="rounded-full border border-red-600/30 px-4 py-2 text-xs uppercase tracking-[0.18em] text-red-500/70 transition hover:border-red-600 hover:text-red-500"
              >
                Delete
              </button>
            )}
