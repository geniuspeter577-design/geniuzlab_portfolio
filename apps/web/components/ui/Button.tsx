...
const variants = {
  primary: "bg-ink text-paper px-4 py-2.5 sm:px-5 sm:py-3 hover:bg-brass transition-all hover:shadow-[0_2px_8px_rgba(126,217,87,0.2)]",
  ghost:
    "border border-ink/25 text-ink px-4 py-2.5 sm:px-5 sm:py-3 hover:border-ink hover:bg-ink hover:text-paper transition-all",
  inverse: "bg-paper text-ink px-4 py-2.5 sm:px-5 sm:py-3 hover:bg-brass hover:text-cinema-ink transition-all",
   ...
   */
  brand:
    "rounded-full bg-[image:var(--gradient-brand-button)] text-cinema px-5 py-2.5 sm:px-6 sm:py-3 shadow-[0_0_0_1px_rgba(126,217,87,0.35),0_8px_28px_-8px_rgba(126,217,87,0.55)] transition-[filter,box-shadow,transform] hover:brightness-110 hover:shadow-[0_0_0_1px_rgba(126,217,87,0.5),0_10px_34px_-6px_rgba(126,217,87,0.7)] hover:scale-105 active:scale-95",
} as const;
